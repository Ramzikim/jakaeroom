...
export function MediaDisplay({life,bubble,character,carrier}:{life:RefObject<Life>,bubble:RefObject<HTMLDivElement|null>,character:RefObject<T.Sprite|null>,carrier:RefObject<T.Group|null>}){
 ...
 return <>
  ...
  {news&&<Html position={[-.6,1.6,3.55]} zIndexRange={[21,1]} style={{pointerEvents:'none'}} calculatePosition={(object,camera,size)=>{
  ...
  }}><div ref={element} className="tv-news"><strong>TV 뉴스</strong><div>{news}</div></div></Html>}
 </>;
}
